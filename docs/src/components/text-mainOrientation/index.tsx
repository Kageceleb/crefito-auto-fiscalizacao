export const MainOrientation: React.FC = () => {
    return (
        <div>
            ...
            <ul>
                <li>Revise os pontos indicados e tomar as medidas necessárias;</li>
                <li>Alertar sua gestão sobre os ajustes que precisam ser feitos;</li>
                <li>Garanta um ambiente regular e seguro para você e sua equipe.</li>
            </ul>
        </div>
    )
}