...
export const mockAnswer: questionarieAnswer[] = [

  {
    ...
    "shouldAnswer": (answers) => { return answers[0] === "Não" || answers[0] === "Não Sei" },
  },
  {
    "id": 2,
    ...
    ,
    "shouldAnswer": (answers) => { return answers[1] === "Não" || answers[2] === "Não" || answers[3] === "Não" },
  },
  {
    "id": 3,
    ...
    "shouldAnswer": (answers) => { return answers[4] === "Não" },
  },
  {
    "id": 4,
    ...
    "shouldAnswer": (answers) => { return answers[5] === "Não" || answers[6] === "Não" || answers[7] === "Não" || answers[8] === "Não" },
  },
  {
    "id": 6,
    ...
    "shouldAnswer": (answers) => { return answers[9] === "Não" },
  },
  {
    "id": 7,
  ...
  },
  {
    ...
    "shouldAnswer": (answers) => { return ((Number(answers[10]) / Number(answers[11])) <= 10) },
  },
  {
    "id": 9,
    "answer": "que o local está disponibilizando os atendimentos por um período menor do que o devido.",
    "shouldAnswer": (answers) => { return (Number(answers[11]) * Number(answers[12])) <= 18 },
  },
]
